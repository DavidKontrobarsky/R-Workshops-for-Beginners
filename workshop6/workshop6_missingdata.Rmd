...
## Visualising Missing Data ![](http://visdat.njtierney.com/reference/figures/visdat-logo.png){width="10%" height="10%"}
...
## [naniar](http://naniar.njtierney.com) ![](images/naniar.png){width="10%" height="10%"}
...
![](images/datawrangling.jpg){width="100%" height="100%"}  
<br>
...
4. Handle missing values `naniar`

5. Create plots to understand the dataset

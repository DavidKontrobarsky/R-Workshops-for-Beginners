...
```{r}
# Check wether the packages exist and install the required pakage
...
<<<<<<< HEAD:workshop2_rmarkdwon.Rmd
#### **Please set up your computer with the following instructions:**
=======
#### **Please set up your computer with following instructions:**
>>>>>>> e11b71fd909853888685ffbab56d7bf5eb66c3c0:workshop2_rmarkdown.Rmd

#### 1. Please enter this link into your web browser : http://bit.ly/MonashBA-R

#### 2. Go down to `Workshop Contents`, then click `Introduction to R Markdown(16 August)` to open the material for workshop 2.
...
But R Markdown allows you to embed R code in a Markdown document, produce **textual output** along with **graphics** in a **single file**. 

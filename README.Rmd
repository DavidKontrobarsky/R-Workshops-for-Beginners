...
* Workshop 4 - [Data Types and Import Data (30 August)](https://ebsmonash.shinyapps.io/workshop4_datatype/)
     ...
     * Download data: 
     ...
     <td><a href="workshop4/data/mtcars.sas7bdat" download="mtcars.sas7bdat">mtcars.sas7bdat</a></td>
     <td><a href="workshop4/data/mtcars.sav" download="mtcars.sav">mtcars.sav</a></td>
     <td><a href="workshop4/data/rock.csv" download="rock.csv">rock.csv</a></td>
     <td></td>
     </tr>
     </table>
<br>
...
* Workshop 6 - [Data Wrangling 2 (13 September)](https://ebsmonash.shinyapps.io/workshop6_missingdata/)
     ...
     * Download data: 
     ...
     <table>
     <tr>
     <td><a href="workshop6/data/CO2.tsv" download="CO2.tsv">CO2.tsv</a></td>
     <td><a href="workshop6/data/deaths.xlsx" download="deaths.xlsx">deaths.xlsx</a></td>
     <td><a href="workshop6/data/iris.csv" download="iris.csv">iris.csv</a></td>
     </tr>
     <tr>
     <td><a href="workshop6/data/mortality.xlsx" download="mortality.xlsx">mortality.xlsx</a></td>
     <td><a href="workshop6/data/rock.csv" download="rock.csv">rock.csv</a></td>
     <td><a href="workshop6/data/survey.csv" download="survey.csv">survey.csv</a></td>
     td><a href="workshop6/data/painters.csv" download="painters.csv">painters.csv</a></td>
     </tr>
     </table>
<br>
